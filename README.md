...
---
<samp>
  <code>fffftt</code> is an audio-geometry exihibit for experimenting with ideas in fixed-function signal visualization, originally inspired by <a href="https://www.shadertoy.com/">shadertoy</a>. It targets Dreamcast as a hardware case study using <a href="https://github.com/raysan5/raylib">raylib</a>, OpenGL 1.1 <a href="https://en.wikipedia.org/wiki/Fixed-function_(computer_graphics)">fixed-function</a> rendering, <a href="https://github.com/kazade/GLdc">GLdc</a>, and <a href="https://github.com/gyrovorbis/sh4zam">sh4zam</a>'s <code>shz_fft()</code><br><br>
</samp>


<samp>[overview]<br>
  &nbsp;&nbsp;&nbsp;&nbsp;.h file ........................... prototyping/shared functions used across the demos <a href="https://github.com/meisei4/fffftt/blob/main/src/fffftt.h">src/fffftt.h</a><br>
  &nbsp;&nbsp;&nbsp;&nbsp;.c files .......................... one demo per file in <a href="https://github.com/meisei4/fffftt/tree/main/src">src/</a>, each with a matching Makefile target<br>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;controls .......................... cycle audio tracks, pause/resume, inspect/seek, move light source<br><!-- add a nice control scheme for gamepad-->
  &nbsp;&nbsp;&nbsp;&nbsp;audio terrain demos ............... see <a href="#audio-terrain">[audio terrain]</a> below<br>
  &nbsp;&nbsp;&nbsp;&nbsp;shadertoy ports ................... see <a href="#shadertoy-ports">[shadertoy ports]</a> below<br>
<br>
</samp>
...
<samp>[audio terrain]<br>
  &nbsp;&nbsp;&nbsp;&nbsp;[waveform terrain]<br>
  &nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/meisei4/fffftt/blob/main/src/waveform_terrain_3d_dc.c">src/waveform_terrain_3d_dc.c</a> ...... uses <b>Hilbert-filtered envelope</b>, <b>RMS</b>, and naive <b>onset strength</b><br>
</samp>
...
<samp>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/meisei4/fffftt/blob/main/src/fft_bands_terrain_3d_dc.c">src/fft_bands_terrain_3d_dc.c</a> ..... uses low/mid/high FFT bands and <b>spectral flatness</b> glitter<br><br>
</samp>
...
<samp>[shadertoy ports]<br>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[meisei4: basic fft visualizer] (<a href="https://www.shadertoy.com/view/t3jGzm">https://www.shadertoy.com/view/t3jGzm</a>) <a href="https://github.com/meisei4/fffftt/blob/main/src/sh4zam_butterfly.c">src/sh4zam_butterfly.c</a>
...
<samp>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[Cotterzz: Visualiser - Picking out notes] (<a href="https://www.shadertoy.com/view/tcG3Rm">https://www.shadertoy.com/view/tcG3Rm</a>) <a href="https://github.com/meisei4/fffftt/blob/main/src/picking_out_notes_dc.c">src/picking_out_notes_dc.c</a><br>
</samp>
<table width="928">
  <tr>
    <td width="464" align="center">
...
<samp>
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[meisei4: basic waveform data visualizer] (<a href="https://www.shadertoy.com/view/tcSXRz">https://www.shadertoy.com/view/tcSXRz</a>) <a href="https://github.com/meisei4/fffftt/blob/main/src/waveform_dc.c">src/waveform_dc.c</a><br>
</samp>
<table width="928">
  <tr>
    <td width="464" align="center">
...
<samp>
  &nbsp;&nbsp;&nbsp;[meisei4: sound envelope reference] (<a href="https://www.shadertoy.com/view/7fXSWB">https://www.shadertoy.com/view/7fXSWB</a>) <a href="https://github.com/meisei4/fffftt/blob/main/src/sound_envelope_dc.c">src/sound_envelope_dc.c</a> / <a href="https://github.com/meisei4/fffftt/blob/main/src/sound_envelope_3d_dc.c">sound_envelope_3d_dc.c</a><br>
...
make picking-out-notes-dc # -> out: build/sh4/picking_out_notes_dc/picking_out_notes_dc.elf + run: ./bin/picking_out_notes_dc
make fft-terrain-3d-dc # -> out: build/dc/fft_terrain_3d_dc/fft_terrain_3d_dc.elf + run: ./bin/fft_terrain_3d_dc
make fft-bands-terrain-3d-dc # -> out: build/dc/fft_bands_terrain_3d_dc/fft_bands_terrain_3d_dc.elf + run: ./bin/fft_bands_terrain_3d_dc
...
make waveform-terrain-3d-dc # -> out: build/dc/waveform_terrain_3d_dc/waveform_terrain_3d_dc.elf + run: ./bin/waveform_terrain_3d_dc
```


<samp>[run / build / clean]<br>
  &nbsp;&nbsp;&nbsp;&nbsp;flycast_run.sh .................... <a href="https://github.com/meisei4/fffftt/blob/main/flycast_run.sh">flycast_run.sh</a> runs generated Dreamcast launcher wrappers under <code>./bin/</code><br>
  &nbsp;&nbsp;&nbsp;&nbsp;.elf targets ...................... references to <code>/pc</code> assets enter CDI build stage through <code>mkdcdisc</code><br>
  &nbsp;&nbsp;&nbsp;&nbsp;build.sh .......................... <a href="https://github.com/meisei4/fffftt/blob/main/build.sh">build.sh</a> builds all examples<br>
  &nbsp;&nbsp;&nbsp;&nbsp;make clean-all .................... removes build artifacts, including <code>.cdi</code> images<br>
</samp>
...
<samp>[third party]<br>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;KallistiOS ........................ <a href="https://github.com/KallistiOS/KallistiOS">github.com/KallistiOS/KallistiOS</a> / <a href="https://kos-docs.dreamcast.wiki/">kos-docs.dreamcast.wiki</a><br>
  &nbsp;&nbsp;&nbsp;&nbsp;mkdcdisc .......................... <a href="https://gitlab.com/simulant/mkdcdisc">gitlab.com/simulant/mkdcdisc</a><br>
  &nbsp;&nbsp;&nbsp;&nbsp;shadertoy ......................... <a href="https://www.shadertoy.com/">shadertoy.com</a> / <a href="https://shadertoyunofficial.wordpress.com/2019/07/23/shadertoy-media-files/">shadertoy media files</a><br>
</samp>
